...
===========
    - Backward compatibility:
        Only breakpoint tables up until version 7.1 have been parsed and tested with.

    - Preprocessing:
        Currently, the automatic preprocessing via the function is very sensitive to any changes.
        Generally the macro should be deleted from the excel file again after every run otherwise to ensure correct execution.
